 ...
 * 
 * Each {@code Violation} is defined by four attributes to describe the violation clearly:
 * 
 * <ul>
 ...
 *  <li>xPath - an XPath expression which can be used to navigate to the affected element.</li>
 * </ul>
 * 
 * Moreover, the attribute message can be used to provide a description of the violation.
 */
...
public class Violation {
	 ...
	 * Constructor 
	 * 
	 * @param constraint id of the failed constraint
	 * @param fileName name of the affected file
	 * @param line line number
	 * @param xPath XPath expression to the affected element/attribute
	...
	public String toString() {
		String str = "["+fileName+", line "+line+"]: Violation of "+constraint;
