...
public class Ext106 {
	...
	public void testConstraintEventFail() throws Exception {
		File f = new File(
				"D:\\Philipp\\BA\\testprocesses\\106\\fail_cancel_end_event.bpmn");
	...
	public void testConstraintEventRefFail() throws Exception {
		File f = new File(
				"D:\\Philipp\\BA\\testprocesses\\106\\fail_sub_process.bpmn");
		boolean valid = SchematronBPMNValidator.validateViaPureSchematron(f);
		assertEquals(valid, false);
		assertEquals(
				SchematronBPMNValidator.getErrors(),
	...
	public void testConstraintSuccess() throws Exception {
		File f = new File("D:\\Philipp\\BA\\testprocesses\\106\\success.bpmn");
		boolean valid = SchematronBPMNValidator.validateViaPureSchematron(f);
